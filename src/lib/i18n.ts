...
export const dictionaries = {
  bn: {
    ...
    'product.perPound': 'প্রতি পাউন্ড',
    'product.perKg': 'প্রতি কেজি',
    'product.unitPound': 'পাউন্ড',
    'product.unitKg': 'কেজি',
    'product.selectWeight': 'ওজন বাছুন',
    'product.customWeight': 'কাস্টম ওজন',
    'product.weightError': 'সঠিক ওজন লিখুন',

    'gallery.title': 'গ্যালারি',
    'gallery.kicker': 'আমাদের কেক',
    'gallery.subtitle': 'অ্যাডমিন আপলোড করা আসল কেকের ছবি।',
    'gallery.empty': 'এখনো কোনো ছবি নেই',
    'gallery.emptyBody': 'নতুন কেকের ছবি এলে এখানে দেখাবে।',
    'gallery.openProduct': 'এই কেক দেখুন',
    'home.gallery': 'গ্যালারি',
    'home.gallerySub': 'আমাদের বেক করা কেকের ছবি',
    'profile.gallery': 'গ্যালারি',
    ...
    'profile.tagline': 'ভালোবাসায় বেক করা',
    'profile.member': 'কেক লাভার',
    'profile.statOrders': 'অর্ডার',
    'profile.statWishlist': 'উইশ',
    'profile.statCoupons': 'কুপন',
    'profile.statAddresses': 'ঠিকানা',
    'profile.inviteBanner': 'বন্ধুকে ইনভাইট করুন — দুজনেই পাবেন ৳১০০',
    'profile.recentOrders': 'সাম্প্রতিক অর্ডার',
    'profile.quickAccess': 'কুইক অ্যাক্সেস',
    'profile.accountSection': 'অ্যাকাউন্ট',
    'profile.moreSection': 'আরও',
    'profile.walletBalance': 'ওয়ালেট',
    'profile.noOrdersYet': 'এখনো কোনো অর্ডার নেই',
    'profile.orderCake': 'কেক অর্ডার করুন',
    'profile.guestHero': 'কেক, অর্ডার আর রিওয়ার্ড এক জায়গায়',
    'profile.changeCover': 'কভার ছবি বদলান',
    'profile.coverHint': 'কভারে ট্যাপ করে ছবি বদলান',
  ...
  en: {
    ...
    'product.perPound': 'per pound',
    'product.perKg': 'per kg',
    'product.unitPound': 'lb',
    'product.unitKg': 'kg',
    'product.selectWeight': 'Select weight',
    'product.customWeight': 'Custom weight',
    'product.weightError': 'Please enter a valid weight',

    'gallery.title': 'Gallery',
    'gallery.kicker': 'Our cakes',
    'gallery.subtitle': 'Real cakes from the Bake Art Style kitchen.',
    'gallery.empty': 'No photos yet',
    'gallery.emptyBody': 'New cake photos will show up here.',
    'gallery.openProduct': 'View this cake',
    'home.gallery': 'Gallery',
    'home.gallerySub': 'Photos of cakes we baked',
    ...
    'profile.tagline': 'Baked with love',
    'profile.member': 'Cake lover',
    'profile.statOrders': 'Orders',
    'profile.statWishlist': 'Wishlist',
    'profile.statCoupons': 'Coupons',
    'profile.statAddresses': 'Addresses',
    'profile.inviteBanner': 'Invite a friend — you both get ৳100',
    ...
    'profile.orderCake': 'Order a cake',
    'profile.guestHero': 'Cakes, orders, and rewards in one place',
    'profile.changeCover': 'Change cover photo',
    'profile.coverHint': 'Tap the cover to change the photo',
