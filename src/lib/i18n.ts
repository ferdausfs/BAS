...
export const dictionaries = {
  bn: {
    ...
    'welcome.kicker': 'বেক আর্ট স্টাইল',
    'welcome.title': 'স্বাগতম, {name}',
    'welcome.body': 'লগইন হয়েছে। পছন্দের কেক বেছে নিন — উইশলিস্ট, অর্ডার আর ঠিকানা এখন সেভ থাকবে।',
    'welcome.cta': 'চালিয়ে যান',
    'welcome.friend': 'বন্ধু',
    'common.order': 'অর্ডার',
  ...
  en: {
    ...
    'welcome.kicker': 'Bake Art Style',
    'welcome.title': 'Welcome, {name}',
    'welcome.body': 'You are in. Browse cakes — wishlist, orders, and addresses stay saved.',
    'welcome.cta': 'Continue',
    'welcome.friend': 'there',
    'common.order': 'Order',
