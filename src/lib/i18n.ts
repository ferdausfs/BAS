...
export const dictionaries = {
  bn: {
    ...
    'home.signinHelperBody': 'একবার সাইন ইন করলে পছন্দের কেক, প্রোমো আর অর্ডার হিস্ট্রি এখানেই থাকবে।',
    ...
    'profile.signInTitle': 'সাইন ইন',
    'profile.signInBody': 'ঠিকানা, অর্ডার, উইশলিস্ট ও প্রোফাইল সেভ করতে সাইন ইন করুন।',
