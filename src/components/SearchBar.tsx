        ...
        {value ? (
          ...
          onOpenOccasions && (
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-[13px] bg-white/70 text-coral transition active:scale-90"
