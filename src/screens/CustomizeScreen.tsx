  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-3 px-5 pt-4 pb-3">
        <button
          onClick={back}
          className="flex h-10 w-10 items-center justify-center rounded-full bg-white transition active:scale-90"
      ...
      <div className="no-scrollbar flex-1 overflow-y-auto px-5 pb-8">
        <div className="mt-2 rounded-2xl glass-strong p-4 anim-up">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-display text-[14px] font-bold text-ink">আপনার স্বপ্নের কেক</h3>
              <p className="text-[11px] text-ink/50">প্রতিটা কাস্টম কেক আলাদা — চলুন সরাসরি কথা বলি</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-3.5 rounded-2xl glass-strong p-4 anim-up delay-1">
          <div className="mb-3 flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-display text-[14px] font-bold text-ink">রেফারেন্স ছবি</h3>
              <p className="text-[11px] text-ink/50">যেমন কেক চান তার ছবি দিন (ঐচ্ছিক)</p>
            </div>
          </div>
          {refImagePreview ? (
            ...
            <label className="flex h-36 cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-ink/15 bg-cream active:bg-ink-50">
              <Camera className="h-9 w-9 text-ink-200" strokeWidth={1.5} />
              <span className="text-[12px] font-semibold text-ink/50">ছবি আপলোড করতে ট্যাপ করুন</span>
              <span className="text-[10px] text-ink/30">JPG, PNG — সর্বোচ্চ ৫MB</span>
        ...
        <div className="mt-3.5 rounded-2xl glass-strong p-4 anim-up delay-2">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-xl border-2 border-ink/10 bg-cream px-3 py-2.5 text-[13px] outline-none focus:border-coral"
          />
        ...
        <a
          ...
          className="mt-5 flex h-13 w-full items-center justify-center gap-2.5 rounded-2xl bg-[#25D366] py-3.5 text-[14px] font-bold text-white transition active:scale-[.98] anim-up delay-3"
          style={{ boxShadow: '0 14px 28px -14px rgba(37,211,102,.5)' }}
        >
